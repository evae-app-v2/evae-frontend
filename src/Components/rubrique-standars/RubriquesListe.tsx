...
const RubriqueListe = () => {
    ...
    return (
        ...
        <span className="absolute">
                ...
                <div className="flex flex-col mt-8" >
                    <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                            <div className="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg" style={{maxHeight: 'calc(6 * 70px)', overflowY: 'auto' }}>
                                            ...
                                            <tr>
                                                ...
                                                <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div className="flex items-center gap-x-6">
                                                        <button onClick={handleOpenDialogDelete}
            ...
            <RubriqueForm open={dialogOpen} setOpen={setDialogOpen}/>
            <DialogDelete
