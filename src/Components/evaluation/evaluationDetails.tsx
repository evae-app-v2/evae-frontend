...
import {faChevronDown, faChevronUp, faCircleXmark, faEye, faXmark} from "@fortawesome/free-solid-svg-icons";
                        ...
                        <table className="w-full min-w-max table-auto text-left border border-blue-gray-200">
                            ...
                            {evaluation?.rubriques.map((rubrique, index) => (
                                <React.Fragment key={index}>
                                    ...
                                    {showQuestions[index] && rubrique.questions.map((question, indexQ) => (
