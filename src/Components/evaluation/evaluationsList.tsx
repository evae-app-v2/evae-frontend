                                ...
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    <thead className="bg-gray-100 dark:bg-gray-700 sticky top-0 ">
                                        <tr>
                                            ...
                                            <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-black-400 dark:text-gray-400" style={{ textAlign: "center" }}>Actions</th>
                                        </tr>
                                    </thead>
                                                ...
                                                <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div className="flex items-center justify-center gap-x-6">
                                                        ...
                                                        <button
                                                            ...
                                                            title={evaluation.etat !== "ELA" ? "Impossible de modifier cette évaluation car elle n'est plusgit  en cours d'élaboration." : ""}
