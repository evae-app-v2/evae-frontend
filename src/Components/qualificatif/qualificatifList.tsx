...
import {QualificatifForm} from "./RubriqueForm";
        ...
        try {
            let response: Qualificatif[] = [];
                ...
                if (sortOrder === "asc") {
                    ...
                    response.sort((a, b) => b.maximal.localeCompare(a.maximal));
                }
    ...
    return (
        ...
        <span className="absolute">
                                                        ...
                                                        <div className="flex items-center gap-x-2">
                                                            <div>
                                                                <h2 className="font-medium text-gray-800 dark:text-white"
                                                                    style={{textAlign: "center"}}>{qualificatif.maximal}</h2></div>
                                                        </div>
                                                    </div>
                                                </td>
            ...
            <DialogDelete
                ...
                message="Voulez-vous vraiment supprimer ce couple qualificatif ?"
                id={idQualificatif}
                name={"qualificatif"}
