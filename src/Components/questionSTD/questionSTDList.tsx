                                                    ...
                                                    <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                        <div className="flex items-center gap-x-6">
                                                            <button onClick={() => handleOpenDialogUpdate(question)}
                                                                    ...
                                                                    className={`text-blue-600 transition-colors duration-200 dark:text-gray-400 dark:hover:text-yellow-400 hover:text-blue-600 focus:outline-none ${disabledButtons[question.id ?? ''] ? "cursor-not-allowed opacity-50" : ""}`}
                                                            ...
                                                            <button
                                                                ...
                                                                className={`text-red-500 transition-colors duration-200 dark:text-gray-400 dark:hover:text-red-400 hover:text-red-500 focus:outline-none ${disabledButtons[question.id ?? ''] ? "cursor-not-allowed opacity-50" : ""}`}>
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                     viewBox="0 0 24 24"
                                                                     strokeWidth="1.5" stroke="currentColor"
                                                                     className="w-5 h-5"
